...
pub fn prepare_arguments(
    ...
    implicit_args.push(execution_context.syscall_segment.clone().into());
...
pub fn execute_call_entry_point(
    ...
    let args = prepare_arguments(call_entry_point, &execution_context);
    ...
    Ok(extract_execution_return_data(&execution_context.vm)?)
}
