...
pub struct ExecutionContext<'a, S: State> {
...
) -> Result<ExecutionContext<'a, impl State>, PreExecutionError> {
...
pub fn run_entry_point(
    ...
    hint_processor: &mut SyscallHintProcessor<'_, impl State>,
...
pub fn finalize_execution(
    vm: VirtualMachine,
    call_entry_point: CallEntryPoint,
    syscall_handler: SyscallHintProcessor<'_, impl State>,
