...
use crate::test_utils::{
    create_test_state, trivial_external_entry_point_for_test, TEST_CLASS_HASH,
...
fn test_calculate_contract_address() {
    ...
    fn run_test(
        ...
        let entry_point_call = CallEntryPoint {
            calldata,
            entry_point_selector: get_selector_from_name("test_get_contract_address"),
            ..trivial_external_entry_point_for_test()
        };
