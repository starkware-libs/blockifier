...
fn test_entry_point_with_arg() -> Result<()> {
    ...
    let entry_point = CallEntryPoint::new(test_contract, "with_arg", calldata);
    assert_eq!(entry_point.execute()?, Vec::<BigInt>::new());
    Ok(())
}
...
fn test_entry_point_with_builtin() -> Result<()> {
    ...
    let entry_point = CallEntryPoint::new(test_contract, "bitwise_and", calldata);
    assert_eq!(entry_point.execute()?, Vec::<BigInt>::new());
    Ok(())
}
...
fn test_entry_point_with_hint() -> Result<()> {
    ...
    let entry_point = CallEntryPoint::new(test_contract, "sqrt", calldata);
    assert_eq!(entry_point.execute()?, Vec::<BigInt>::new());
    Ok(())
}
...
fn test_entry_point_with_return_value() -> Result<()> {
    ...
    let entry_point = CallEntryPoint::new(test_contract, "return_result", calldata);
