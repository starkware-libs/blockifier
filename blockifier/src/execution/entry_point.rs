...
use crate::execution::errors::{EntryPointExecutionError, PreprocessExecutionError};
...
impl CallEntryPoint {
    ...
    pub fn find_entry_point_in_contract(&self) -> Result<&EntryPoint, PreprocessExecutionError> {
        ...
        match entry_points_of_same_type.iter().find(|ep| ep.selector == self.entry_point_selector) {
            ...
            None => Err(PreprocessExecutionError::EntryPointNotFound(self.entry_point_selector)),
        }
    }
}
