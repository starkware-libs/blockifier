...
fn cast_between_storage_mapping_types() {
    type IndexedStorageMap = IndexMap<ContractAddress, IndexMap<StorageKey, StarkFelt>>;

    let empty_map = IndexedStorageMap::default();
