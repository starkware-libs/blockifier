...
// TODO(Adi, 10/02/2022): Delete once the gas price is evaluated from some source.
pub const GAS_PRICE: u128 = 1;

// TODO: Replace with 'account_contract_without_validations' once the syscalls are implemented.
