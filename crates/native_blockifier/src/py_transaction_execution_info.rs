...
impl PyBouncerInfo {
    pub fn calculate(
        ...
        let gas_weight = actual_resources.0.get("l1_gas_usage").ok_or(
        ...
        let n_steps = additional_os_resources.n_steps
            ...
            + actual_resources.0.get("n_steps").ok_or(
                TransactionExecutionError::InvalidTransactionExecutionInfo {
                    field: "n_steps".to_string(),
                },
            )?;
        let pedersen_builtin = actual_resources.0.get("pedersen_builtin").ok_or(
            TransactionExecutionError::InvalidTransactionExecutionInfo {
        ...
        let range_check_builtin = actual_resources.0.get("range_check_builtin").ok_or(
            TransactionExecutionError::InvalidTransactionExecutionInfo {
