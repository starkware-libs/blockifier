...
// Convertor functions for CallType and EntryPointType because enums can not implement IntoPy.
impl PyCallInfo {
...
impl From<CallInfo> for PyCallInfo {
    fn from(call_info: CallInfo) -> Self {
        ...
        Self {
            ...
            entry_point_type: PyCallInfo::enrty_point_type_to_u8(call.entry_point_type),
            ...
            accessed_storage_keys: call_info
                ...
                .collect(),
            call_type: PyCallInfo::call_type_to_u8(call.call_type),
