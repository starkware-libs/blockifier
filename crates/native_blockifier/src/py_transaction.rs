...
use starknet_api::transaction::{
    Calldata, ContractAddressSalt, DeclareTransaction as StarknetApiDeclareTransaction,
    DeclareTransactionV0V1, DeployAccountTransaction, Fee, InvokeTransaction, InvokeTransactionV0,
    InvokeTransactionV1, L1HandlerTransaction, TransactionHash, TransactionSignature,
    TransactionVersion,
};
...
pub fn py_declare(tx: &PyAny) -> NativeBlockifierResult<StarknetApiDeclareTransaction> {
    ...
    match version {
        0 => Ok(StarknetApiDeclareTransaction::V0(declare_tx)),
        1 => Ok(StarknetApiDeclareTransaction::V1(declare_tx)),
