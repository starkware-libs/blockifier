...
use crate::py_utils::{biguint_to_felt, to_chain_id_enum, validate_storage_aligned};
...
impl PyTransactionExecutor {
    ...
    pub fn create(
        ...
        validate_storage_aligned(&storage, latest_block_id)?;
        let block_context = py_block_context(general_config, block_info)?;
        build_tx_executor(block_context, storage)
    }
