...
use crate::py_block_executor::{into_block_info_and_chain_info, PyGeneralConfig};
...
impl PyValidator {
    ...
    pub fn create(
        ...
        let (block_info, chain_info) =
            into_block_info_and_chain_info(&general_config, &next_block_info)?;
