...
impl PyValidator {
    ...
    pub fn perform_validations(
        ...
        // processed.
        let skip_validate = skip_validate_due_to_unprocessed_deploy_account(
            self,
            &account_tx,
...
pub fn skip_validate_due_to_unprocessed_deploy_account(
    ...
    let nonce = py_validator.stateful_validator.get_nonce(tx_info.sender_address())?;
    ...
    let nonce_small_enough_to_qualify_for_validation_skip =
        tx_nonce <= py_validator.max_nonce_for_validation_skip;
