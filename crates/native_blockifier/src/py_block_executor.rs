...
impl PyBlockExecutor {
    ...
    pub fn execute(
        ...
        let prev_total_timer = self.tx_executor().state.state.total_timer;
        log::debug!("AYELET prev_timer");
        log::debug!("{}", prev_timer);
        log::debug!("AYELET prev_total_timer");
        log::debug!("{}", prev_total_timer);
        ...
        let total_timer = self.tx_executor().state.state.total_timer;
        log::debug!("{}", total_timer);
