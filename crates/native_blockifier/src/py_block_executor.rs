...
use blockifier::state::cached_state::{GlobalContractCache, TEST_GLOBAL_CONTRACT_CACHE_SIZE};
use pyo3::prelude::*;
...
impl PyBlockExecutor {
    ...
    fn create_for_testing(general_config: PyGeneralConfig, path: std::path::PathBuf) -> Self {
        Self {
            ...
            tx_executor: None,
            global_contract_cache: GlobalContractCache::new(TEST_GLOBAL_CONTRACT_CACHE_SIZE),
        }
    }
}
