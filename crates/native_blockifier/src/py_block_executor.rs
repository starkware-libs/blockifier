...
pub fn pre_process_block(
    ...
    let old_block_number_and_hash = old_block_number_and_hash.map(|(block_number, block_hash)| {
        BlockNumberAndHash::new(BlockNumber(block_number), BlockHash(block_hash.0))
    });
