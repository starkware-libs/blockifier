...
const INVOKE_VERSIONS: [u8; 3] = [0, 1, 3];
const DECLARE_VERSIONS: [u8; 4] = [0, 1, 2, 3];
const DEPLOY_ACCOUNT_VERSIONS: [u8; 3] = [0, 1, 3];
...
/// }
/// ```
fn vary_over_versions(args: TokenStream, stream: TokenStream, versions: &[u8]) -> TokenStream {
