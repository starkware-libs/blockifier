    ...
    pub fn from_api(
        ...
        match tx {
            ...
            StarknetApiTransaction::Declare(declare) => {
                ...
                let declare_tx = if query {
                    DeclareTransaction::new_query(declare, contract_class)
                } else {
            ...
            StarknetApiTransaction::DeployAccount(deploy_account) => {
                let deploy_account_tx = if query {
                    DeployAccountTransaction::new_query(deploy_account)
                } else {
            ...
            StarknetApiTransaction::Invoke(invoke) => {
                let invoke_tx = if query {
                    InvokeTransaction::new_query(invoke)
                } else {
