...
use starknet_api::hash::{FeltConverter, StarkHash, TryIntoFelt};
...
fn test_revert_invoke(
    ...
    assert_eq!(
        state
            ...
            .unwrap(),
        (felt!(BALANCE - tx_execution_info.actual_fee.0), felt!(0_u8))
    );
