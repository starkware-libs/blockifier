...
#[fixture]
fn da_gas_no_write_v0() -> GasVector {
    GasVector { l1_gas: 862, l1_data_gas: 0 }
}
#[fixture]
fn da_gas_no_write_v1_v3() -> GasVector {
    GasVector { l1_gas: 1652, l1_data_gas: 0 }
}
#[fixture]
fn da_gas_single_write_v1_v3() -> GasVector {
    GasVector { l1_gas: 2754, l1_data_gas: 0 }
}
#[fixture]
fn addional_data_write_and_reset() -> Vec<StarkFelt> {
    vec![16_u8.into(), 1_u8.into(), 16_u8.into(), 0_u8.into()]
}
#[fixture]
fn addional_data_modify_twice_same_cell() -> Vec<StarkFelt> {
    vec![16_u8.into(), 1_u8.into(), 16_u8.into(), 2_u8.into()]
}
#[rstest]
...
#[case::validate_execute_reset_no_revert(
    WRITE_VALIDATE_EXECUTE,
    addional_data_write_and_reset(),
    da_gas_no_write_v1_v3(),
    false
)]
#[case::validate_reset_no_revert(
    WRITE_VALIDATE_ONLY,
    addional_data_write_and_reset(),
    da_gas_no_write_v1_v3(),
    false
)]
#[case::execute_reset_no_revert(
    WRITE_EXECUTE_ONLY,
    addional_data_write_and_reset(),
    da_gas_no_write_v1_v3(),
    false
...
#[case::validate_execute_modify_no_revert(
    WRITE_VALIDATE_EXECUTE,
    addional_data_modify_twice_same_cell(),
    da_gas_single_write_v1_v3(),
    false
)]
#[case::validate_modify_no_revert(
    WRITE_VALIDATE_ONLY,
    addional_data_modify_twice_same_cell(),
    da_gas_single_write_v1_v3(),
    false
)]
#[case::execute_modify_no_revert(
    WRITE_EXECUTE_ONLY,
    addional_data_modify_twice_same_cell(),
    da_gas_single_write_v1_v3(),
    false
...
#[case::validate_execute_reset_revert(
    WRITE_VALIDATE_FAIL_EXECUTE,
    addional_data_write_and_reset(),
    da_gas_single_write_v1_v3(),
    true
)]
#[case::validate_execute_modify_revert(
    WRITE_VALIDATE_FAIL_EXECUTE,
    addional_data_modify_twice_same_cell(),
    da_gas_single_write_v1_v3(),
    true
...
fn test_count_actual_storage_changes_with_storage_writes_in_validation(
    block_context: BlockContext,
    #[case] scenario: u64,
    #[case] addional_data: Vec<StarkFelt>,
    #[case] expected_da_gas_usage: GasVector,
    ...
    let scenario_info = [vec![scenario.into()], addional_data].concat();
...
fn test_count_actual_storage_changes_with_storage_writes_in_validation_v0(
    ...
    // Scenario: Validation changes storage, execution resets same storage (undo), execution passes.
    // Expected: No storage changes, da_gas as if no writes happened.
    let expected_da_gas_usage = da_gas_no_write_v0();
    ...
    let scenario_info = [vec![scenario.into()], addional_data_write_and_reset()].concat();
    let fake_signature = TransactionSignature(scenario_info);
    let invoke_args = invoke_tx_args! {
        signature: fake_signature,
        sender_address: account_address,
