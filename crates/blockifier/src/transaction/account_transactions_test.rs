    ...
    let error = run_invoke_tx(
        ...
        invoke_tx_args! {
            ...
            resource_bounds: l1_resource_bounds(
                u64::try_from(estimated_min_l1_gas).expect("Failed to convert u128 to u64."),
...
fn test_recursion_depth_exceeded(
    ...
    let max_inner_recursion_depth = u8::try_from(block_context.max_recursion_depth - 2)
...
fn test_reverted_reach_steps_limit(
    ...
    let fail_depth = block_context.invoke_tx_max_n_steps
        / (u32::try_from(steps_diff).expect("Failed to convert usize to u32."));
...
fn test_max_fee_to_max_steps_conversion(
    ...
    let actual_fee =
        u128::try_from(actual_gas_used).expect("Failed to convert u64 to u128.") * 100000000000;
