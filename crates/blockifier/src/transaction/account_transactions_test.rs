...
use crate::test_utils::initial_test_state::{set_account_balance, test_state};
...
fn test_fail_deploy_account(
    ...
    let deploy_account_tx = create_account_tx_for_validate_test(
        FaultyAccountTxCreatorArgs {
            ...
            faulty_account: faulty_account_feature_contract,
            sender_address: contract_address!(0_u32), // Irrelevant contract address.
            contract_address_salt,
            max_fee: Some(Fee(BALANCE)),
        },
        &mut NonceManager::default(),
    );
    ...
    set_account_balance(&block_context, deploy_address, BALANCE * 2, state);
