...
fn test_count_actual_storage_changes(
    ...
    let state_changes_count_1 =
        state_changes_1.clone().count(Some(account_address), fee_token_address);
    ...
    let state_changes_count_2 =
        state_changes_2.clone().count(Some(account_address), fee_token_address);
    ...
    let state_changes_count_3 =
        state_changes_transfer.clone().count(Some(account_address), fee_token_address);
