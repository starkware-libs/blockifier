...
fn test_reverted_reach_steps_limit(
    ...
    println!("n_steps_0: {}", n_steps_0);
    println!("actual_fee_0: {}", actual_fee_0);
    ...
    // Ensure the transaction was not reverted.
    assert!(!result.is_reverted());
    println!("n_steps_1: {}", n_steps_1);
    println!("actual_fee_1: {}", actual_fee_1);
    ...
    let n_steps_237 = result.actual_resources.0.get("n_steps").unwrap();
    let actual_fee_237 = result.actual_fee.0;
    ...
    println!("n_steps_237: {}", n_steps_237);
    println!("actual_fee_237: {}", actual_fee_237);
    ...
    let n_steps_238 = result.actual_resources.0.get("n_steps").unwrap();
    let actual_fee_238 = result.actual_fee.0;
    // Ensure the transaction was reverted.
    assert!(result.is_reverted());
    println!("n_steps_238: {}", n_steps_238);
    println!("actual_fee_238: {}", actual_fee_238);
    ...
    // Ensure the transaction was reverted.
    assert!(result.is_reverted());
    println!("n_steps_250: {}", n_steps_fail);
    println!("actual_fee_250: {}", actual_fee_fail);
    ...
    // Ensure the transaction was reverted.
    assert!(result.is_reverted());
    println!("n_steps_251: {}", n_steps_fail_next);
    println!("actual_fee_251: {}", actual_fee_fail_next);
}
