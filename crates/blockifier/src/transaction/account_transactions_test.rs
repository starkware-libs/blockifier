...
fn test_max_fee_to_max_steps_conversion(
    ...
    let gas_used1 =
        calculate_tx_l1_gas_usage(&tx_execution_info1.actual_resources, versioned_constants)
            .unwrap();
    ...
    let gas_used2 =
        calculate_tx_l1_gas_usage(&tx_execution_info2.actual_resources, versioned_constants)
            .unwrap();
