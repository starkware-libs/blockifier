...
fn test_recursion_depth_exceeded(
    ...
    // Fix the recursion depth to be one more than the max allowed, triggers the error we want.
    let exceeding_recursion_depth = block_context.max_recursion_depth + 1;
    ...
    let calldata = calldata![
        ...
        raw_contract_address,
        raw_entry_point_selector,
        stark_felt!(exceeding_recursion_depth as u8)
    ];
