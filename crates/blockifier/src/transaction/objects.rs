...
impl ExecutionSummary {
    pub fn merge(&mut self, other: ExecutionSummary) {
        self.executed_class_hashes.extend(other.executed_class_hashes.iter().cloned());
        self.visited_storage_entries.extend(other.visited_storage_entries.iter().cloned());
