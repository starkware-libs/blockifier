...
pub struct TransactionExecutionInfo {
    /// Transaction validation call info; [None] for
    /// [L1HandlerTransaction](`starknet_api::transaction::L1HandlerTransaction`).
    pub validate_call_info: Option<CallInfo>,
    /// Transaction execution call info; [None] for
    /// [DeclareTransaction](`starknet_api::transaction::DeclareTransaction`).
    pub execute_call_info: Option<CallInfo>,
    /// Fee transfer call info; [None] for
    /// [L1HandlerTransaction](`starknet_api::transaction::L1HandlerTransaction`).
