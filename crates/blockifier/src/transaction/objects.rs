...
impl StarknetResources {
    ...
    /// Computes the message segment length and L1 gas usage of L1->L2 messages
    /// when they are posted onchain.
    // TODO(Nimrod, 1/5/2024): Find a better name for this function.
