...
impl AccountTransactionContext {
    ...
    pub fn max_fee(&self, gas_prices: GasPrices) -> Fee {
        match self {
            Self::Current(context) => {
                ...
                Fee(l1_resource_bounds.max_amount as u128
                    * gas_prices.get_by_fee_type(&FeeType::Strk))
            }
            Self::Deprecated(context) => context.max_fee,
        }
    }

    pub fn enforce_fee(&self, gas_prices: GasPrices) -> bool {
        self.max_fee(gas_prices) != Fee(0)
    }
