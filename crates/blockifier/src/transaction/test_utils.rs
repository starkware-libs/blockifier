...
use crate::test_utils::{
    lower_balance_key, test_erc20_account_balance_key, DictStateReader, NonceManager,
...
pub fn create_state_with_falliable_validation_account() -> CachedState<DictStateReader> {
    ...
    create_account_tx_test_state(
        ...
        lower_balance_key(TEST_FAULTY_CAIRO0_ACCOUNT_CONTRACT_ADDRESS),
        account_balance * 2,
    )
}
...
pub fn create_state_with_falliable_validation_cairo1_account() -> CachedState<DictStateReader> {
    ...
    create_account_tx_test_state(
        ...
        lower_balance_key(TEST_FAULTY_CAIRO1_ACCOUNT_CONTRACT_ADDRESS),
        account_balance * 2,
    )
}

pub fn get_test_account_address_and_class_hash<'a>(
    ...
    match tx_type {
        ...
        TransactionType::InvokeFunction => {
            ...
            let execute_calldata = calldata![
                stark_felt!(account_contract_address), // Contract address.
