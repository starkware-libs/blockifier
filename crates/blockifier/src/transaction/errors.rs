...
use crate::execution::errors::{
    gen_transaction_execution_error_trace, DeployError, EntryPointExecutionError,
};
...
pub enum TransactionExecutionError {
    ...
    ContractConstructorExecutionFailed { error: DeployError, storage_address: ContractAddress },
