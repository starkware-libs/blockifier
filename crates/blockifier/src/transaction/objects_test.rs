...
fn test_summarize(
    ...
    let validate_call_info =
        ExecutionSummaryParameters::create_call_info_for_testing(&validate_params);
    let execute_call_info =
        ExecutionSummaryParameters::create_call_info_for_testing(&execute_params);
    let fee_transfer_call_info =
        ExecutionSummaryParameters::create_call_info_for_testing(&fee_transfer_params);
