...
impl AccountTransaction {
    ...
    fn run_or_revert<S: StateReader>(
        ...
        // TODO(zuphit): replace fee_steps estimation by a more concrete const/calc.
        let fee_steps: usize = 5500;
        ...
        execution_context.subtract_steps(validate_steps + fee_steps);
