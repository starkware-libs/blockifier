...
impl AccountTransaction {
    ...
    fn run_non_revertible<S: StateReader>(
        ...
        let actual_cost = TransactionReceipt::of_account_tx(
            self,
            &tx_context,
        ...
        let bouncer_resources = actual_cost.resources.clone();
    ...
    fn run_revertible<S: StateReader>(
        ...
        let revert_cost = TransactionReceipt::of_account_tx(
            self,
            &tx_context,
        ...
        //   cost.
        let bouncer_revert_resources = TransactionReceipt::of_account_tx(
            self,
            &tx_context,
            &validate_state_changes,
            &resources,
