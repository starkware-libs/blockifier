...
impl ExecutableTransaction for DeclareTransaction {
    fn execute_tx(
        &self,
...
impl ValidatableTransaction for DeclareTransaction {
...
impl ExecutableTransaction for DeployAccountTransaction {
    fn execute_tx(
        &self,
        state: &mut dyn State,
...
impl ValidatableTransaction for DeployAccountTransaction {
    fn validate_entrypoint_calldata(&self) -> Calldata {
...
impl ExecutableTransaction for InvokeTransaction {
    fn execute_tx(
        &self,
        state: &mut dyn State,
        block_context: &BlockContext,
...
impl ValidatableTransaction for InvokeTransaction {
...
impl ExecutableTransaction for L1HandlerTransaction {
    fn execute_tx(
        &self,
        state: &mut dyn State,
        block_context: &BlockContext,
