...
pub struct DeclareTransaction {
    ...
    #[allow(dead_code)]
    pub chargeable_class_info: ChargeableClassInfo,
}
...
impl DeclareTransaction {
    fn create(
        ...
        let chargeable_class_info = ChargeableClassInfo {
            casm_length: contract_class.bytecode_length(),
            // TODO(Ayelet,10/02/2024): Fill these fields.
            sierra_length: 0,
            abi_length: 0,
        };
        Ok(Self { tx: declare_tx, tx_hash, contract_class, only_query, chargeable_class_info })
    }
