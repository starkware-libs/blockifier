        ...
        match &self.tx {
            ...
            | starknet_api::transaction::DeclareTransaction::V1(_) => {
                match context
                    ...
                    .block_context
                    .versioned_constants
                    .disable_cairo0_redeclaration
                {
                    true => self.try_decleare(
                        state,
                        class_hash,
                        // For undeclared contract classes, when trying to get the compiled
                        // contract class, the initial compiled class hash
                        // is set to zero. In cairo 0, where there is no compiled class hash, we take
                        // advantage of this fact, and set the compiled class hash to zero.
            ...
            | starknet_api::transaction::DeclareTransaction::V3(DeclareTransactionV3 {
                compiled_class_hash,
                ..
            }) => self.try_decleare(state, class_hash, *compiled_class_hash),
        }
    }
}
