...
use crate::test_utils::{
    create_test_state_util, ACCOUNT_CONTRACT_PATH, TEST_ACCOUNT_CONTRACT_CLASS_HASH,
};
use crate::transaction::deploy_account_transaction::execute_tx;
use crate::transaction::objects::AccountTransactionContext;

fn create_test_state() -> CachedState<DictStateReader> {
    create_test_state_util(TEST_ACCOUNT_CONTRACT_CLASS_HASH, ACCOUNT_CONTRACT_PATH, "0x0")
}
