...
use crate::test_utils::{
    ...
    BALANCE, MAX_FEE, TEST_ACCOUNT_CONTRACT_ADDRESS,
    ...
    TEST_FAULTY_ACCOUNT_CONTRACT_CLASS_HASH, TEST_FAULTY_ACCOUNT_CONTRACT_PATH, TEST_EMPTY_CONTRACT_CAIRO1_PATH,
};
