...
use crate::test_utils::{
    ...
    TEST_FAULTY_CAIRO0_ACCOUNT_CONTRACT_ADDRESS, TEST_FAULTY_CAIRO0_ACCOUNT_CONTRACT_CLASS_HASH,
    TEST_FAULTY_CAIRO1_ACCOUNT_CONTRACT_ADDRESS, TEST_FAULTY_CAIRO1_ACCOUNT_CONTRACT_CLASS_HASH,
};
...
use crate::transaction::test_utils::{
    ...
    create_state_with_trivial_validation_account, CairoVersion, CALL_CONTRACT, INVALID, VALID,
};
...
#[test_case(
    ...
    TestInvokeTxArguments{
        ...
        validate_gas_consumed: 14760,
        execute_gas_consumed: 104560,
        inner_call_initial_gas: 319320,
...
fn test_invoke_tx(
    ...
    let expected_return_result_call = CallEntryPoint {
        ...
        call_type: CallType::Call,
        initial_gas: abi_constants::INITIAL_GAS_COST - expected_arguments.inner_call_initial_gas,
    };
    ...
    F: FnMut() -> CachedState<DictStateReader>,
{
        ...
        F: FnMut() -> CachedState<DictStateReader>,
    {
        ...
        let (account_contract_address, account_contract_class_hash) = match cairo_version {
            CairoVersion::Cairo0 => (
