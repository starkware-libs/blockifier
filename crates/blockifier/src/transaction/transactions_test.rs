...
fn test_invoke_tx() {
    ...
    let expected_execution_info = TransactionExecutionInfo {
        ...
        actual_resources: ResourcesMapping(HashMap::from([
            (abi_constants::L1_GAS_USAGE.to_string(), 1224),
            ("pedersen_builtin".to_string(), 16),
            ("range_check_builtin".to_string(), 101),
            (abi_constants::N_STEPS.to_string(), 4082),
        ])),
        n_storage_updates: 0,
...
fn test_declare_tx() {
    ...
    let expected_execution_info = TransactionExecutionInfo {
        ...
        actual_resources: ResourcesMapping(HashMap::from([
            ...
            (abi_constants::N_STEPS.to_string(), 2688),
        ])),
        n_storage_updates: 0,
        n_modified_contracts: 0,
        n_class_updates: 0,
...
fn test_deploy_account_tx() {
    ...
    let expected_execution_info = TransactionExecutionInfo {
        ...
        actual_fee: expected_actual_fee,
        actual_resources: ResourcesMapping(HashMap::from([
            (abi_constants::L1_GAS_USAGE.to_string(), 3060),
            ("pedersen_builtin".to_string(), 23),
            ("range_check_builtin".to_string(), 83),
            (abi_constants::N_STEPS.to_string(), 3584),
        ])),
        n_storage_updates: 0,
