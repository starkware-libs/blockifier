...
use crate::transaction::objects::{
    HasTransactionVersion, ResourcesMapping, TransactionExecutionInfo,
};
...
fn test_invoke_tx(
    ...
    let tx_version = &account_tx.version();
    ...
    let expected_actual_fee =
        calculate_tx_fee(&actual_execution_info.actual_resources, block_context, tx_version)
            .unwrap();
