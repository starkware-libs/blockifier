...
use starknet_api::transaction::{
    Calldata, DeclareTransaction, DeclareTransactionV1, DeployAccountTransaction, EventContent,
    EventData, EventKey, Fee, InvokeTransactionV1, TransactionVersion,
};
...
fn test_negative_invoke_tx_flows() {
    ...
    let invalid_tx = AccountTransaction::Invoke(InvokeTransactionV1 { ..valid_invoke_tx.clone() });
...
fn declare_tx() -> DeclareTransactionV1 {
