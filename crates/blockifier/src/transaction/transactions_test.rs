...
fn test_calculate_tx_gas_usage() {
    ...
    let l1_gas_usage =
        calculate_tx_gas_usage(&[], n_modified_contracts, n_storage_updates, None, 0);
    ...
    // A tx that changes the account balance in execute.
    ...
    let n_storage_updates = 2; // For the recipient and the account update.
