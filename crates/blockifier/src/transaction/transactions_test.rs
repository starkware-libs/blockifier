...
fn test_only_query_flag(#[case] only_query: bool) {
    ...
    let sender_address =
        FeatureContract::AccountWithoutValidations(CairoVersion::Cairo1).get_address(0);
    let test_contract_address = FeatureContract::TestContract(CairoVersion::Cairo1).get_address(0);
