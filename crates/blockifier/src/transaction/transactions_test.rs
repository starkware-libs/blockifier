...
#[test_case(
    vec![stark_felt!(1_u16)],
    vec![stark_felt!(2_u16)],
    SYSCALL_MAX_EVENTS_COUNT + 1,
    Some(EmitEventError::ExceedsNumberOfEvents {
...
#[test_case(
    ...
    1,
    Some(EmitEventError::ExceedsKeyLength{
...
#[test_case(
    ...
    1,
    Some(EmitEventError::ExceedsDataLength{
...
fn test_emit_event_exceeds_limit(
    ...
    for cairo_version in [0, 1] {
        ...
        let calldata = [
            vec![stark_felt!(number_events as u16)].to_owned(),
