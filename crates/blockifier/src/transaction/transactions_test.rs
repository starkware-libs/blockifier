...
#[rstest]
#[case(TransactionType::InvokeFunction, false)] // test __validate__
#[case(TransactionType::Declare, false)] // test __validate_declare__
#[case(TransactionType::DeployAccount, false)] // test __validate_deploy__
#[case(TransactionType::DeployAccount, true)] // test constructor
