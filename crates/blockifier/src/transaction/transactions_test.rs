...
#[test_case(CairoVersion::Cairo0, CairoVersion::Cairo0; "With Cairo0 account")]
#[test_case(CairoVersion::Cairo1, CairoVersion::Cairo0; "With Cairo1 account")]
...
fn test_calculate_tx_gas_usage() {
    ...
    let some_other_contract = FeatureContract::FaultyAccount(account_cairo_version);
    let some_other_account_address = some_other_contract.get_instance_address(0);
    let execute_calldata = create_calldata(
        fee_token_address,
