...
use crate::transaction::test_utils::{
    account_invoke_tx, calculate_sierra_program_length_for_testing,
    create_account_tx_for_validate_test, l1_resource_bounds, FaultyAccountTxCreatorArgs,
    CALL_CONTRACT, GET_BLOCK_HASH, INVALID, VALID,
};
use crate::transaction::transaction_types::TransactionType;
use crate::transaction::transactions::{ClassInfo, ExecutableTransaction, L1HandlerTransaction};
...
fn test_max_fee_exceeds_balance(account_cairo_version: CairoVersion) {
    ...
    let class_info = ClassInfo {
        contract_class: contract_to_declare.get_class(),
