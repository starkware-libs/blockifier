...
fn test_invoke_tx(
    ...
    let expected_execution_info = TransactionExecutionInfo {
        ...
        actual_resources: ResourcesMapping(HashMap::from([
            ...
            (HASH_BUILTIN_NAME.to_string(), 10 + calldata_length),
...
fn test_l1_handler(#[values(false, true)] use_kzg_da: bool) {
    ...
    let expected_resource_mapping = ResourcesMapping(HashMap::from([
        (HASH_BUILTIN_NAME.to_string(), 9 + payload_size),
        (abi_constants::N_STEPS_RESOURCE.to_string(), 1379),
    ...
    assert_matches!(
        ...
        TransactionExecutionError::TransactionFeeError(
            ...
            if paid_fee == Fee(0) && actual_fee == Fee(1740200000000000)
    );
}
