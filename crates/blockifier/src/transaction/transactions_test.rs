...
use crate::{
    ...
    check_transaction_execution_error_on_constructor_for_custom_hint,
    check_transaction_execution_error_on_non_constructor_for_custom_hint, declare_tx_args,
...
fn test_validate_accounts_tx(#[case] tx_type: TransactionType) {
    ...
    let error = account_tx.execute(state, block_context, true, true).unwrap_err();
    check_transaction_execution_error_on_non_constructor_for_custom_hint!(
        &error,
