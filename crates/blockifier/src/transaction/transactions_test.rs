...
fn get_l1_handler_tx(calldata: &Calldata, l1_fee: Fee) -> L1HandlerTransaction {
...
fn test_l1_handler() {
    ...
    let l1_handler_tx = get_l1_handler_tx(&calldata, Fee(1));
    ...
    let l1_handler_tx_no_fee = get_l1_handler_tx(&calldata, Fee(0));
