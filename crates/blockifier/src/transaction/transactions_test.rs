...
fn test_invalid_nonce(state: &mut CachedState<DictStateReader>) {
    ...
    // Strict, negative flow: account_nonce = 0, incoming_tx_nonce = 1.
    ...
    // Positive flow: account_nonce = 0, incoming_tx_nonce = 1.
    ...
    // Negative flow: account_nonce = 1, incoming_tx_nonce = 0.
