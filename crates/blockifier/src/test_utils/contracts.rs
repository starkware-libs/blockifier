...
const TESTING_ACCOUNT_BASE: u32 = 9 * CLASS_HASH_BASE;
...
const TESTING_ACCOUNT_NAME: &str = "account_testing";
...
impl FeatureContract {
    ...
    fn get_integer_base(self) -> u32 {
        self.get_cairo_version_bit()
            + match self {
                ...
                Self::TestAccount(_) => TESTING_ACCOUNT_BASE,
            }
    }
    ...
    fn get_compiled_path(&self) -> String {
        ...
        let contract_name = match self {
            ...
            Self::TestAccount(_) => TESTING_ACCOUNT_NAME,
