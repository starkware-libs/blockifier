...
pub fn test_state(
    ...
    address_to_class_hash.insert(cairo0_account.get_address(0), cairo0_account.get_class_hash());
    ...
    for (contract, n_instances) in contract_instances.iter() {
        ...
        for instance in 0..*n_instances {
            address_to_class_hash.insert(contract.get_address(instance), class_hash);
