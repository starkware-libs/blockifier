...
/// Fee transfer cost depends non-trivially on the account contract address (address is part of a
/// hash preimage, the value of which effects the flow of `normalize_address`).
#[memoize::memoize]
