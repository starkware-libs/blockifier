...
impl StateCache {
    ...
    fn get_compiled_class_hash_updates(&self) -> HashMap<ClassHash, CompiledClassHash> {
        // This is not a strict subtraction, as Papyrus does not support the get_compiled_class_hash
        // function. Therefore, we cannot write the class hash. Hence,
        // compiled_class_hash_writes keys cannot be a subset of
        // compiled_class_hash_initial_values keys
        subtract_mappings(
            &self.compiled_class_hash_writes,
