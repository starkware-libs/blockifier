...
impl<S: StateReader> CachedState<S> {
    ...
    // This method locks the Mutex and unwraps the MutexGuard, thus exposing the internal cache
...
impl<S: StateReader> StateReader for CachedState<S> {
    ...
    fn get_compiled_contract_class(
        ...
        // At this point in this method, the contract class has either been found in the global
        // cache, or found in self.class_hash_to_class, or else retrieved from the storage and
        // inserted into self.class_hash_to_class.
        // Therefore, it must be either in self.class_hash_to_class or in the global cache.
