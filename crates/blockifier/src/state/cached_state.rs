...
/// Represents the interim state of a transaction that has been executed but not yet committed to
/// the blockchain. Can be passed to external services that validate and count resources to decide
