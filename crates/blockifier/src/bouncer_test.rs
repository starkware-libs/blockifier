...
#[rstest]
#[case(Bouncer::new(BouncerConfig::default()))]
#[case(Bouncer {
...
fn test_bouncer_update(#[case] initial_bouncer: Bouncer) {
    ...
    let mut expected_bouncer = initial_bouncer.clone();
    expected_bouncer
    ...
    expected_bouncer.accumulated_weights = expected_bouncer.accumulated_weights + weights_to_update;
