...
fn common_map_setup() -> HashMap<ContractAddress, ClassHash> {
    ...
    map.insert(contract_address!(TEST_CONTRACT_ADDRESS), class_hash!(TEST_CLASS_HASH));
    map.insert(contract_address!(TEST_CONTRACT_ADDRESS_2), class_hash!(TEST_CLASS_HASH));
    map.insert(
