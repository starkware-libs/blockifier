...
pub fn test_erc20_sequencer_balance_key() -> StorageKey {
    get_erc20_balance_var_address(&contract_address!(TEST_SEQUENCER_ADDRESS)).unwrap()
}
pub fn test_erc20_account_balance_key() -> StorageKey {
    get_erc20_balance_var_address(&contract_address!(TEST_ACCOUNT_CONTRACT_ADDRESS)).unwrap()
}
pub fn test_erc20_faulty_account_balance_key() -> StorageKey {
    get_erc20_balance_var_address(&contract_address!(TEST_FAULTY_ACCOUNT_CONTRACT_ADDRESS)).unwrap()
}
