...
#[macro_export]
macro_rules! check_transaction_execution_error_on_constructor_for_custom_hint {
    ($error:expr, $expected_hint:expr $(,)?) => {
        match $error {
...
#[macro_export]
macro_rules! check_transaction_execution_error_on_non_constructor_for_custom_hint {
    ($error:expr, $expected_hint:expr $(,)?) => {
        match $error {
