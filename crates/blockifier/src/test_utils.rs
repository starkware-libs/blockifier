...
// TODO(Dori, 1/9/2023): NEW_TOKEN_SUPPORT add a max fee value for the new fee token.
...
pub const DEFAULT_DEPRECATED_L1_GAS_PRICE: u128 = 100 * u128::pow(10, 9); // Given in units of wei.
...
impl BlockContext {
    pub fn create_for_testing() -> BlockContext {
        BlockContext {
            ...
            deprecated_l1_gas_price: DEFAULT_DEPRECATED_L1_GAS_PRICE,
