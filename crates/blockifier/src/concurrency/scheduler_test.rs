...
#[rstest]
#[case::done(DEFAULT_CHUNK_SIZE, DEFAULT_CHUNK_SIZE, true, true, Task::Done)]
#[case::no_task(DEFAULT_CHUNK_SIZE, DEFAULT_CHUNK_SIZE, false, true, Task::NoTask)]
#[case::no_task_as_validation_index_not_executed(DEFAULT_CHUNK_SIZE, 0, false, false, Task::NoTask)]
#[case::execution_task(0, 0, false, true, Task::ExecutionTask(0))]
#[case::execution_task_as_validation_index_not_executed(1, 0, false, false, Task::ExecutionTask(1))]
#[case::validation_task(1, 0, false, true, Task::ValidationTask(0))]
fn test_next_task(
    #[case] execution_index: usize,
    #[case] validation_index: usize,
    #[case] done_marker: bool,
    #[case] set_validation_index_status_to_executed: bool,
    ...
    if validation_index < execution_index
        && validation_index < DEFAULT_CHUNK_SIZE
        && set_validation_index_status_to_executed
    {
        scheduler.set_tx_status(validation_index, Some(TransactionStatus::Executed));
    }
...
#[rstest]
#[case::from_ready_to_execute_to_executing(0, Some(TransactionStatus::ReadyToExecute), Some(0))]
#[case::executing(0, Some(TransactionStatus::Executing), None)]
#[case::executed(0, Some(TransactionStatus::Executed), None)]
#[case::aborting(0, Some(TransactionStatus::Aborting), None)]
#[case::index_out_of_bounds(DEFAULT_CHUNK_SIZE, None, None)]
...
#[rstest]
#[case::ready(1, Some(TransactionStatus::ReadyToExecute), None)]
#[case::executing(1, Some(TransactionStatus::Executing), None)]
#[case::executed(1, Some(TransactionStatus::Executed), Some(1))]
#[case::aborting(1, Some(TransactionStatus::Aborting), None)]
#[case::index_out_of_bounds(DEFAULT_CHUNK_SIZE, None, None)]
...
#[rstest]
#[case::ready(1, Some(TransactionStatus::ReadyToExecute), Some(1))]
#[case::executing(1, Some(TransactionStatus::Executing), None)]
#[case::executed(1, Some(TransactionStatus::Executed), None)]
#[case::aborting(1, Some(TransactionStatus::Aborting), None)]
#[case::index_out_of_bounds(DEFAULT_CHUNK_SIZE, None, None)]
