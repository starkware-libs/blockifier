...
#[rstest]
fn test_decrease_validation_index_happy_flow(#[values(0, 1, 5)] target_index: TxIndex) {
    let scheduler =
        default_scheduler!(chunk_size: DEFAULT_CHUNK_SIZE, validation_index: target_index + 1);
...
fn test_decrease_validation_index_tmp_assertion(
