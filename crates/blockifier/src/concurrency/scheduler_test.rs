...
#[case::execution_task(0, 0, false, TransactionStatus::ReadyToExecute, Task::ExecutionTask(0))]
...
#[rstest]
#[case::from_ready_to_execute_to_executing(0, TransactionStatus::ReadyToExecute, Some(0))]
...
#[rstest]
#[case::ready(1, TransactionStatus::ReadyToExecute, None)]
...
#[rstest]
#[case::ready(1, TransactionStatus::ReadyToExecute, Some(1))]
#[case::executing(1, TransactionStatus::Executing, None)]
