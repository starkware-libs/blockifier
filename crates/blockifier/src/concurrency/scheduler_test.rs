...
#[rstest]
#[case::done(DEFAULT_CHUNK_SIZE, DEFAULT_CHUNK_SIZE, true, TransactionStatus::Executed, Task::Done)]
#[case::no_task(
    DEFAULT_CHUNK_SIZE,
    DEFAULT_CHUNK_SIZE,
    false,
...
#[case::execution_task(0, 0, false, TransactionStatus::Executed, Task::ExecutionTask(0))]
...
#[case::validation_task(1, 0, false, TransactionStatus::Executed, Task::ValidationTask(0))]
fn test_next_task(
    #[case] execution_index: usize,
    #[case] validation_index: usize,
    ...
    if validation_index < execution_index && validation_index < DEFAULT_CHUNK_SIZE {
        scheduler.set_tx_status(validation_index, Some(validation_index_status))
    }
