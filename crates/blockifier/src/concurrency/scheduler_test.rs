...
#[rstest]
#[case::sets_ready_status(TransactionStatus::Aborting)]
...
fn test_try_validation_abort(#[case] tx_status: TransactionStatus, #[case] expected_result: bool) {
    let tx_index = 0;
    let scheduler = Scheduler::new(DEFAULT_CHUNK_SIZE);
    scheduler.set_tx_status(tx_index, tx_status);
...
#[rstest]
#[case::not_aborted(0, TransactionStatus::Executed, 10, false)]
#[case::returns_execution_task(0, TransactionStatus::Aborting, 10, true)]
#[case::does_not_return_execution_task(10, TransactionStatus::Aborting, 0, true)]
