...
use crate::test_utils::initial_test_state::{fund_account, test_state_reader};
...
pub fn test_fix_call_info(
    ...
    let mut state_reader = test_state_reader(chain_info, BALANCE, &[(account, 1)], erc20_version);
    ...
    let state = &mut CachedState::from(state_reader);
