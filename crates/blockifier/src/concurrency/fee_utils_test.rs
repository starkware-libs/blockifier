...
use crate::concurrency::test_utils::create_fee_transfer_call_data;
use crate::context::BlockContext;
use crate::invoke_tx_args;
use crate::test_utils::contracts::FeatureContract;
use crate::test_utils::initial_test_state::{fund_account, test_state, test_state_cairo1};
...
pub fn test_fix_call_info(
    ...
    let state = &mut match erc20_version {
        CairoVersion::Cairo0 => test_state(chain_info, BALANCE, &[(account, 1)]),
        CairoVersion::Cairo1 => test_state_cairo1(chain_info, BALANCE, &[(account, 1)]),
    };
