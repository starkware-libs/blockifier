...
impl<S: StateReader> VersionedState<S> {
    ...
    pub fn get_storage_at(
        ...
        Ok(self.storage.read(version, (contract_address, key)).unwrap_or({
    ...
    pub fn get_nonce_at(
        ...
        Ok(self.nonces.read(version, contract_address).unwrap_or({
    ...
    pub fn get_class_hash_at(
        ...
        Ok(self.class_hashes.read(version, contract_address).unwrap_or({
    ...
    pub fn get_compiled_class_hash(
        ...
        Ok(self.compiled_class_hashes.read(version, class_hash).unwrap_or({
    ...
    pub fn get_compiled_contract_class(
        ...
        Ok(self.compiled_contract_classes.read(version, class_hash).unwrap_or({
