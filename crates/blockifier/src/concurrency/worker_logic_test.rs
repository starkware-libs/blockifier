...
#[case::overflow(Fee(150_u128), stark_felt!(u128::max_value()), StarkFelt::from_u128(5_u128))]
pub fn test_add_fee_to_sequencer_balance(
    ...
    let expected_sequencer_balance_value_low =
        Felt252::from(&expected_balance % BigUint::from(2u8).pow(128));
    let expected_sequencer_balance_value_high = stark_felt_to_felt(sequencer_balance_high)
        + Felt252::from(&expected_balance / u128::max_value());
