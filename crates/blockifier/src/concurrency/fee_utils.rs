...
pub fn fix_concurrency_fee_transfer_call_info(
    ...
    assert_eq!(
        call_info.storage_read_values[STORAGE_READ_SEQUENCER_BALANCE_INDICES.0], actual_fee,
    ...
    assert_eq!(
        call_info.storage_read_values[STORAGE_READ_SEQUENCER_BALANCE_INDICES.1], actual_fee,
        "Sequencer balance should be the actual fee"
    );
