...
impl<S: StateReader> VersionedStateProxy<S> {
    ...
    pub fn set_class_hash_at(
        ...
        let mut state = self.state();
        state.class_hashes.write(version, contract_address, class_hash);
    }
    ...
    pub fn set_nonce_at(
        ...
        let mut state = self.state();
        state.nonces.write(version, contract_address, nonce);
    }
    ...
    pub fn set_compiled_class_hash(
        ...
        let mut state = self.state();
        state.compiled_class_hashes.write(version, class_hash, compiled_class_hash);
    }
    ...
    pub fn set_compiled_contract_class(
        ...
        let mut state = self.state();
        state.compiled_contract_classes.write(version, class_hash, contract_class);
    }
}
