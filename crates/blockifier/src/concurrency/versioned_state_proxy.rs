...
impl<S: StateReader> VersionedState<S> {
    ...
    pub fn get_last_writes_up_to_index(&mut self, tx_index: TxIndex) -> StateMaps {
        StateMaps {
            storage: self.storage.get_last_writes_up_to_index(tx_index),
            nonces: self.nonces.get_last_writes_up_to_index(tx_index),
            class_hashes: self.class_hashes.get_last_writes_up_to_index(tx_index),
            compiled_class_hashes: self.compiled_class_hashes.get_last_writes_up_to_index(tx_index),
        ...
        T: StateReader,
    {
        ...
        parent_state.update_contract_class_cache(
            self.compiled_contract_classes.get_last_writes_up_to_index(from_index),
        );
    }
