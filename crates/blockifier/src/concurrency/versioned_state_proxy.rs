...
impl<S: StateReader> VersionedState<S> {
    ...
    // TODO: Consider coupling the tx_index with the read_set to ensure that any mismatch between
    // the transaction index and read set will cause the validation to fail.
