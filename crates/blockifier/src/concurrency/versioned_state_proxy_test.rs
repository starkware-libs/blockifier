...
fn test_versioned_state() {
    ...
    versioned_state_proxys[3].set_storage_at(contract_address, new_key, stark_felt_v3);
    versioned_state_proxys[4].set_nonce_at(contract_address, nonce_v4);
    versioned_state_proxys[7].set_class_hash_at(contract_address, class_hash_v7);
    versioned_state_proxys[10].set_class_hash_at(contract_address, class_hash_v10);
    versioned_state_proxys[18].set_compiled_class_hash(class_hash, compiled_class_hash_v18);
    versioned_state_proxys[11].set_compiled_contract_class(class_hash, contract_class_v11.clone());
