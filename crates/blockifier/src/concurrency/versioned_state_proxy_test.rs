...
fn test_versioned_client_state() {
    ...
    let versioned_client_state_1 = VersionedStateProxy::new(1, Arc::clone(&versioned_state));
    let versioned_client_state_2 = VersionedStateProxy::new(2, Arc::clone(&versioned_state));
...
fn test_run_parallel_txs() {
    ...
    let mut state_1 = CachedState::from(VersionedStateProxy::new(1, Arc::clone(&versioned_state)));
    let mut state_2 = CachedState::from(VersionedStateProxy::new(1, Arc::clone(&versioned_state)));
