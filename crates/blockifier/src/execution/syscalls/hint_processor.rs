    ...
    pub fn execute_next_syscall(
        ...
        match selector {
            SyscallSelector::CallContract => {
                self.execute_syscall(vm, call_contract, self.context.gas_costs().call_contract_gas_cost)
            }
            ...
            SyscallSelector::GetBlockHash => {
                self.execute_syscall(vm, get_block_hash, self.context.gas_costs().get_block_hash_gas_cost)
            }
            ...
            SyscallSelector::LibraryCall => {
                self.execute_syscall(vm, library_call, self.context.gas_costs().library_call_gas_cost)
            }
            ...
            SyscallSelector::ReplaceClass => {
                self.execute_syscall(vm, replace_class, self.context.gas_costs().replace_class_gas_cost)
            }
            SyscallSelector::Secp256k1Add => {
                self.execute_syscall(vm, secp256k1_add, self.context.gas_costs().secp256k1_add_gas_cost)
            }
            ...
            SyscallSelector::Secp256k1Mul => {
                self.execute_syscall(vm, secp256k1_mul, self.context.gas_costs().secp256k1_mul_gas_cost)
            }
            SyscallSelector::Secp256k1New => {
                self.execute_syscall(vm, secp256k1_new, self.context.gas_costs().secp256k1_new_gas_cost)
            }
            SyscallSelector::Secp256r1Add => {
                self.execute_syscall(vm, secp256r1_add, self.context.gas_costs().secp256r1_add_gas_cost)
            }
            ...
            SyscallSelector::Secp256r1Mul => {
                self.execute_syscall(vm, secp256r1_mul, self.context.gas_costs().secp256r1_mul_gas_cost)
            }
            SyscallSelector::Secp256r1New => {
                self.execute_syscall(vm, secp256r1_new, self.context.gas_costs().secp256r1_new_gas_cost)
            }
            ...
            SyscallSelector::StorageRead => {
                self.execute_syscall(vm, storage_read, self.context.gas_costs().storage_read_gas_cost)
            }
            SyscallSelector::StorageWrite => {
                self.execute_syscall(vm, storage_write, self.context.gas_costs().storage_write_gas_cost)
            }
