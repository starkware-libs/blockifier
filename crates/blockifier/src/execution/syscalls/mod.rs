...
use self::hint_processor::{
    ...
    read_call_params, read_calldata, read_felt_array, write_retdata_segment, SyscallExecutionError,
...
impl SyscallResponse for SingleSegmentResponse {
    fn write(self, vm: &mut VirtualMachine, ptr: &mut Relocatable) -> WriteResponseResult {
        write_retdata_segment(vm, ptr, self.segment)
    }
}
...
pub fn deploy(
    ...
    Ok(DeployResponse { contract_address: deployed_contract_address, segment: retdata_segment })
}
