...
pub fn get_block_hash(
    ...
    // We convert to i128 to avoid underflow.
    let upper_bound_block_number =
        current_block_number as i128 - constants::STORED_BLOCK_HASH_BUFFER as i128;
    if requested_block_number as i128 > upper_bound_block_number {
