...
use crate::test_utils::{
    ...
    CURRENT_BLOCK_TIMESTAMP, LEGACY_TEST_CONTRACT_ADDRESS, TEST_CLASS_HASH, TEST_CONTRACT_ADDRESS,
...
#[test_case(
    ...
    true,
    false;
    "Legacy test contract. Execute execution mode: block info should be as usual. Tx version 1.")]
#[test_case(
    ExecutionMode::Execute,
    stark_felt!(TEST_SEQUENCER_ADDRESS),
    Felt252::from(3_u8),
    true,
    false;
    "Legacy test contract. Execute execution mode: block info should be as usual. Tx version 3.")]
fn test_get_execution_info(
    ...
    let max_fee = if is_legacy { Fee(0) } else { Fee(42) };
