...
const TEST_CONTRACT: FeatureContract = FeatureContract::TestContract(CairoVersion::Cairo1);
const EMPTY_CONTRACT: FeatureContract = FeatureContract::Empty(CairoVersion::Cairo1);
