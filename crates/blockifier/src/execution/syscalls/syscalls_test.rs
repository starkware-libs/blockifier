...
fn test_nested_library_call() {
    ...
    let library_call_resources = &get_syscall_resources(DeprecatedSyscallSelector::LibraryCall)
        + &ExecutionResources {
            n_steps: 587,
            n_memory_holes: 2,
    ...
    let main_call_resources = &(&get_syscall_resources(DeprecatedSyscallSelector::LibraryCall) * 3)
        + &ExecutionResources {
            n_steps: 1117,
            n_memory_holes: 4,
