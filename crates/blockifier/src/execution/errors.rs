...
fn match_virtual_machine_error(
    mut error_stack: Vec<String>,
...
fn match_syscall_execution_error(
    ...
    match syscall_error {
        ...
        SyscallExecutionError::LibraryCallExecutionError { storage_address, error, .. } => {
            ...
            // let libcall_preemble = format!("Error in the called contract (hash: {} storage:
            // {}):", class_hash, storage_address.0.key());
            let libcall_preemble =
                format!("Error in the called contract ({}):", storage_address.0.key());
...
fn match_deprecated_syscall_execution_error(
    mut error_stack: Vec<String>,
...
fn match_entry_point_execution_error(
    mut error_stack: Vec<String>,
