...
pub struct ExecutionSummaryParameters {
...
impl ExecutionSummaryParameters {
    pub fn new(
        num_of_events: usize,
    ...
    pub fn create_call_info_for_testing(params: &ExecutionSummaryParameters) -> CallInfo {
        CallInfo {
            call: CallEntryPoint {
            ...
            accessed_storage_keys: vec![params.storage_key].into_iter().collect(),
            ..Default::default()
        }
    }
}
