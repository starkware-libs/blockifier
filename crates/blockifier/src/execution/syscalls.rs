...
pub fn call_contract(
    ...
    let segment = ReadOnlySegment { start_ptr: retdata_segment_start_ptr, length: retdata_length };
...
pub fn delegate_call(
    ...
    let segment = ReadOnlySegment { start_ptr: retdata_segment_start_ptr, length: retdata_length };
    Ok(DelegateCallResponse { segment })
}
...
pub fn get_tx_signature(
    ...
    let segment = ReadOnlySegment { start_ptr, length };
    Ok(GetTxSignatureResponse { segment })
}
