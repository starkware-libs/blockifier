...
fn test_stack_trace() {
    ...
    let first_location = entry_point_offset.0 + 14;
    let second_location = entry_point_offset.0 - 3;
...
Unknown location (pc=0:{first_location})
Unknown location (pc=0:{second_location})
