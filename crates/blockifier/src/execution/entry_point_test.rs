...
use crate::test_utils::{
    create_calldata, less_trivial_external_entry_point, trivial_external_entry_point, CairoVersion,
    BALANCE,
};
...
fn test_stack_trace(
    ...
    let entry_point_call = CallEntryPoint {
        ...
        calldata,
        ..less_trivial_external_entry_point(Some(test_contract_address))
    };
