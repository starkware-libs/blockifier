...
use crate::execution::entry_point::{
    ...
    EntryPointExecutionResult, Retdata, StateContext,
};
...
) -> Result<ExecutionContext<'a, 'b>, PreExecutionError> {
...
pub fn execute_entry_point_call(
    ...
    let previous_vm_resources = ctx.resources_manager.vm_resources.clone();
