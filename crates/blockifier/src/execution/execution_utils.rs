...
/// Deploys a contract: Updates the state with the new contract address to class hash mapping,
/// verifies the class is declared and runs the constructor of the new contract (if exists).
/// Returns the call info of the constructor (or empty call info).
