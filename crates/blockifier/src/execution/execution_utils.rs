...
pub fn execute_entry_point_call(
    ...
    let VmExecutionContext {
        ...
        initial_syscall_ptr,
        entry_point_pc,
    } = initialize_execution_context(&call, class_hash, state, ctx)?;
    ...
    let previous_vm_resources = syscall_handler.ctx.execution_resources.vm_resources.clone();
...
pub fn finalize_execution(
    ...
    syscall_handler.ctx.execution_resources.vm_resources += &vm_resources_without_inner_calls;

    let full_call_vm_resources =
        &syscall_handler.ctx.execution_resources.vm_resources - &previous_vm_resources;
    Ok(CallInfo {
        call,
