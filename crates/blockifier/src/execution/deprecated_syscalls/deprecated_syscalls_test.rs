...
fn test_emit_event() {
    ...
    let max_event_data_length = versioned_constants.event_limits.max_data_length;
    ...
    let max_event_keys_length = versioned_constants.event_limits.max_keys_length;
    ...
    let max_n_emitted_events = versioned_constants.event_limits.max_n_emitted_events;
