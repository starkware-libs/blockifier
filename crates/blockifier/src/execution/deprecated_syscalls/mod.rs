...
pub fn get_block_number(
    ...
    let block_number = match syscall_handler.execution_mode() {
        ExecutionMode::Validate => BlockNumber(
            (block_number.0 / versioned_constants.validate_block_number_rounding) * versioned_constants.validate_block_number_rounding,
        ),
...
pub fn get_block_timestamp(
    ...
    let block_timestamp = match syscall_handler.execution_mode() {
        ExecutionMode::Validate => BlockTimestamp(
            (block_timestamp.0 / versioned_constants.validate_timestamp_rounding) * versioned_constants.validate_timestamp_rounding,
        ),
