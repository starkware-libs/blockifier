...
use crate::utils::{f64_into_u128, usize_from_u128_saturating, usize_into_f64};
...
impl EntryPointExecutionContext {
    ...
    fn max_steps(
        ...
        let tx_upper_bound = usize_from_u128_saturating(f64_into_u128(
            (usize_into_f64(tx_gas_upper_bound)? / gas_per_step).floor(),
        )?);
