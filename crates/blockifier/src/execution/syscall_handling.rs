...
use crate::execution::syscalls::{
    ...
    storage_read, storage_write, StorageReadResponse, StorageWriteRequest, StorageWriteResponse,
...
impl<'a> SyscallHintProcessor<'a> {
    ...
    pub fn set_contract_storage_at(
        ...
        self.accessed_keys.insert(request.address);
        self.state.set_storage_at(self.storage_address, request.address, request.value);
