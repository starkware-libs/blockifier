...
use crate::execution::syscalls::{
    ...
    storage_read, storage_write, StorageReadResponse, SyscallRequest, SyscallResponse,
...
pub fn read(
    ...
    syscall_handler.accessed_keys.insert(address);
    let value = syscall_handler.state.get_storage_at(syscall_handler.storage_address, address)?;
    syscall_handler.read_values.push(value);
