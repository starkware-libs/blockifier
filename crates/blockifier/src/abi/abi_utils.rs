...
/// Returns the storage key corresponding to the first storage cell where the balance of
/// `contract_address` is stored. Note that the reference implementation of an ERC20 stores the
/// balance in two consecutive storage cells.
pub fn get_erc20_balance_var_address(
