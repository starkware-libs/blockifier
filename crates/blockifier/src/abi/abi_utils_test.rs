...
fn test_selector_from_name() {
    ...
    assert_eq!(selector_from_name(DEFAULT_ENTRY_POINT_NAME), expected_default_selector);
    assert_eq!(selector_from_name(DEFAULT_L1_ENTRY_POINT_NAME), expected_default_selector);
    ...
    assert_eq!(selector_from_name(EXECUTE_ENTRY_POINT_NAME), expected_execute_selector);
