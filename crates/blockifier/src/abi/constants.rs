...
pub const SECP256K1_GET_XY_GAS_COST: u64 = 75 * STEP_GAS_COST + 9 * RANGE_CHECK_GAS_COST;
...
pub const SECP256R1_GET_POINT_FROM_X_GAS_COST: u64 =
    446 * STEP_GAS_COST + 44 * RANGE_CHECK_GAS_COST + 20 * MEMORY_HOLE_GAS_COST;
pub const SECP256R1_GET_XY_GAS_COST: u64 = 77 * STEP_GAS_COST + 9 * RANGE_CHECK_GAS_COST;
pub const SECP256R1_MUL_GAS_COST: u64 = 196007 * STEP_GAS_COST + 21477 * RANGE_CHECK_GAS_COST;
pub const SECP256R1_NEW_GAS_COST: u64 =
    530 * STEP_GAS_COST + 49 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST;
