...
pub const SECP256K1_ADD_GAS_COST: u64 =
    406 * STEP_GAS_COST + 29 * RANGE_CHECK_GAS_COST - SYSCALL_BASE_GAS_COST;
...
pub const SECP256K1_MUL_GAS_COST: u64 =
    121956 * STEP_GAS_COST + 10739 * RANGE_CHECK_GAS_COST - SYSCALL_BASE_GAS_COST;
...
pub const SECP256R1_ADD_GAS_COST: u64 =
    589 * STEP_GAS_COST + 57 * RANGE_CHECK_GAS_COST - SYSCALL_BASE_GAS_COST;
...
pub const SECP256R1_GET_XY_GAS_COST: u64 =
    241 * STEP_GAS_COST + 11 * RANGE_CHECK_GAS_COST + 40 * MEMORY_HOLE_GAS_COST
        - SYSCALL_BASE_GAS_COST;
pub const SECP256R1_MUL_GAS_COST: u64 = 195595 * STEP_GAS_COST + 21477 * RANGE_CHECK_GAS_COST;
