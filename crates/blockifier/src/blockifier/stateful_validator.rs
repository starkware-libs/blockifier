...
impl<S: StateReader> StatefulValidator<S> {
    pub fn create(
        ...
        Self { max_nonce_for_validation_skip, tx_executor }
    }

    pub fn indirect_create(
        state_reader: S,
        ...
        let block_context = BlockContext { block_info, chain_info, versioned_constants };

        Self::create(state, block_context, max_nonce_for_validation_skip)
    }
