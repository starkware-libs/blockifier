...
pub struct BouncerWeights {
    gas: u64,
    n_steps: u64,
    n_steps_with_keccak: u64,
    message_segment_length: u64,
    state_diff_size: u64,
    state_diff_size_with_kzg: u64,
    // TODO add more weights (n_memory_holes, builtin_steps)
    // TODO understand how n_steps_with_keccak and state_diff_size_with_kzg special handling
}
...
impl Add for BouncerWeights {
    ...
    fn add(self, other: Self) -> Self {
        BouncerWeights {
            ...
            n_steps_with_keccak: self.n_steps_with_keccak + other.n_steps_with_keccak,
...
impl BouncerWeights {
    pub fn exceeds_limit(self, versioned_constants: &VersionedConstants) -> bool {
        self.gas > versioned_constants.bouncer.max_weights.gas
            || self.n_steps > versioned_constants.bouncer.max_weights.n_steps
            || self.n_steps_with_keccak
                > versioned_constants.bouncer.max_weights.n_steps_with_keccak
