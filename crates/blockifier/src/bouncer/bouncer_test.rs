...
fn test_bouncer_add(
    ...
    let bouncer_weights1 = BouncerWeights {
        ...
        number_of_steps: first_input_weights[1],
        number_of_steps_with_keccak: 0,
    ...
    let bouncer_weights2 = BouncerWeights {
        ...
        number_of_steps: second_input_weights[1],
        number_of_steps_with_keccak: 0,
    ...
    assert_eq!(bouncer.accumulated_block_weights.number_of_steps, final_weights[1]);
