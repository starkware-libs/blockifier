...
fn test_discounted_gas_overdraft(
    ...
    let use_kzg_da: bool = l1_data_gas_used != 0;
    ...
    let state_changes_count = StateChangesCount {
        n_storage_updates: 0,
        n_modified_contracts: l1_data_gas_used / (DATA_GAS_PER_FIELD_ELEMENT * 2),
    ...
    let actual_resources = TransactionResources {
        starknet_resources,
        vm_resources: ExecutionResources { n_steps: l1_gas_used, ..Default::default() },
    };
