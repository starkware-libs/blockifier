...
pub const DISCOUNT_PER_DA_WORD: usize = (0.1 * (SHARP_GAS_PER_MEMORY_WORD as f64)) as usize;
pub const GAS_PER_DA_WORD: usize = SHARP_GAS_PER_MEMORY_WORD - DISCOUNT_PER_DA_WORD;
