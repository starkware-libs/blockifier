...
fn test_calculate_tx_gas_usage_basic() {
    ...
    let (deploy_account_gas_usage, _deploy_account_blob_gas_usage) =
    ...
    let (l1_handler_gas_usage, _l1_handler_blob_gas_usage) = calculate_tx_gas_and_blob_gas_usage(
        std::iter::empty(),
    ...
    let (l2_to_l1_messages_gas_usage, _l2_to_l1_messages_blob_gas_usage) =
        calculate_tx_gas_and_blob_gas_usage(
    ...
    let (storage_writings_gas_usage, _storage_writings_blob_gas_usage) =
        calculate_tx_gas_and_blob_gas_usage(
            std::iter::empty(),
    ...
    let (gas_usage, _blob_gas_usage) = calculate_tx_gas_and_blob_gas_usage(
        call_infos_iter,
