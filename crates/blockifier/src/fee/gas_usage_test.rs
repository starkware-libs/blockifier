...
fn test_calculate_tx_gas_usage_basic(#[values(false, true)] use_kzg_flag: bool) {
    ...
    let (manual_sharp_gas_usage, manual_sharp_blob_gas_usage) = match use_kzg_flag {
        true => (0, calculate_tx_blob_gas_usage(deploy_account_state_changes_count, use_kzg_flag)),
    ...
    let manual_sharp_blob_gas_usage =
        calculate_tx_blob_gas_usage(l2_to_l1_state_changes_count, use_kzg_flag);
    ...
    let (manual_sharp_gas_usage, manual_sharp_blob_gas_usage) = match use_kzg_flag {
        true => (0, calculate_tx_blob_gas_usage(storage_writes_state_changes_count, use_kzg_flag)),
