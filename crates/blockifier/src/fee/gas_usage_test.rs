...
use crate::fee::gas_usage::{get_da_gas_cost, get_events_gas_cost};
...
fn test_get_event_gas_cost(versioned_constants: &VersionedConstants) {
    ...
    assert_eq!(GasVector::default(), get_events_gas_cost(call_infos.iter(), versioned_constants));
    ...
    let gas_vector = get_events_gas_cost(call_infos.iter(), versioned_constants);
