...
fn test_get_event_gas_cost(
    ...
    let call_info_1 = Some(CallInfo::default());
    let call_info_2 = Some(CallInfo::default());
    let call_info_3 = Some(CallInfo::default());
