...
fn test_get_event_gas_cost(versioned_constants: &VersionedConstants) {
    ...
    starknet_resources.set_events_resources(call_infos, versioned_constants);

    assert_eq!(GasVector::default(), starknet_resources.get_events_cost());
    ...
    starknet_resources.set_events_resources(call_infos, versioned_constants);
    let gas_vector = starknet_resources.get_events_cost();
