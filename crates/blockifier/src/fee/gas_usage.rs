...
pub fn get_code_gas_cost(
    ...
    if let Some(class_info) = class_info {
        ...
        let total_code_length =
            class_info.bytecode_length() + class_info.sierra_program_length + class_info.abi_length;
        let code_gas_cost = total_code_length * l2_resource_gas_costs.milligas_per_code_word / 1000;
        GasVector {
