...
/// addition of a transaction with the given parameters to a batch; e.g., a message from L2 to L1 is
/// followed by a storage write operation in Starknet L1 contract which requires gas.
pub fn calculate_tx_gas_usage_without_data(
