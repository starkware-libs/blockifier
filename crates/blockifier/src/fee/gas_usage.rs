...
pub fn get_events_milligas_cost(
    ...
    let l2_resource_gas_costs = versioned_constants.get_l2_resource_gas_cost();
    let (event_key_factor, data_word_cost) =
        (l2_resource_gas_costs.event_key_factor, l2_resource_gas_costs.milligas_per_data_word);
