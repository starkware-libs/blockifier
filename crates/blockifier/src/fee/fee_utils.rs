...
use crate::transaction::objects::{
    FeeType, HasRelatedFeeType, ResourcesMapping, TransactionFeeResult, TransactionInfo,
};
...
pub fn calculate_tx_fee(
    ...
    let l1_gas_usage = calculate_tx_l1_gas_usage(resources, &block_context.versioned_constants)?;
