...
pub fn extract_l1_gas_and_vm_usage(
    ...
    // Returns the default value 0 for l1_blob_gas_usage if it does not appear in resources.
    // TODO(Aner, 21/1/2024): Make sure the value l1_gas_usage_data always appears in resources.
...
pub fn calculate_tx_fee(
    ...
    let [l1_gas_usage, l1_blob_gas_usage] = calculate_tx_l1_gas_usages(resources, block_context)?;
    Ok(get_fee_by_l1_gas_usages(block_context, l1_gas_usage, l1_blob_gas_usage, fee_type))
}
