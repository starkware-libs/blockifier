...
fn os_resources() -> serde_json::Value {
    json!({
        ...
        // For each resource r, a transaction consumes r according to following formula:
        // r_0 + r_m * calldata_length, where r_0 is a constant and r_m is the calldata factor.
        "execute_txs_inner": {
            "Declare": {
                "Constant": {
                    "builtin_instance_counter": {
