...
pub struct ActualCostBuilder<'a> {
    ...
    chargeable_class_info: Option<ChargeableClassInfo>,
}
...
impl<'a> ActualCostBuilder<'a> {
    ...
    pub fn with_chargeable_class_info(
        mut self,
        chargeable_class_info: ChargeableClassInfo,
    ) -> Self {
        self.chargeable_class_info = Some(chargeable_class_info);
        self
    }
